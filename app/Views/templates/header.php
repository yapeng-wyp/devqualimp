...
<head>
    ...
    <script src='/asset/pell/dist/pell.min.js'></script>
    ...
    <link rel='stylesheet' href='/asset/pell/dist/pell.min.css'/>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="#" >
                    <img src="/asset/media/images/logo.svg" style="margin-right: 150px"/>
                        <svg style="display: none" role='img' aria-label="康师傅"
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="http://devqualimp.test/index">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://devqualimp.test/detail">Detail</a>
                        </li>
                        <li class="nav-item dropdown" >
                            <a class="nav-link dropdown-toggle" data-bs-auto-close="true" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
                                Comments
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="http://devqualimp.test/comment_add">Comment Add</a></li>
                                <li><a class="dropdown-item" href="http://devqualimp.test/comment_list">Comment List</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                    ...
                    <form class="d-flex" role="search" style="display: none">
                        <input style="display: none" class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
